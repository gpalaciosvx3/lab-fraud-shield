export class NamingConstants {
  ...
  private static readonly PROJECT = 'FRAUDSHIELD';
  ...
  static readonly KDS_001 = `${NamingConstants.REGION}${NamingConstants.PROJECT}KDS001`;

  static readonly DDB_001 = `${NamingConstants.REGION}${NamingConstants.PROJECT}DDB001`;

  static readonly FHS_001 = `${NamingConstants.REGION}${NamingConstants.PROJECT}FHS001`;
